...
public class RnA06Rej285 implements Supplier<RespostaValidacao> {
    ...
    public RnA06Rej285(DadosCertificado dadosCertificado1, IMap<X509Certificate, X509Certificate> cacheInvalido) {
    ...
    public RespostaValidacao get() {
        ...
        try {
            ...
            return resp285.className(getClass().getName()).trace("falha ao verificar se é ICPBrasil").throwable(ex);
        }
